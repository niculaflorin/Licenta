...
```
$ docker image tag gateway niculaflorin/gateway
$ docker push niculaflorin/gateway
$ docker image tag googlecognitive niculaflorin/googlecognitive
$ docker push niculaflorin/googlecognitive
```
...
$ kubectl apply -f googlecognitive
```
